...
INSERT INTO copy_employees (ID, first_name, last_name, job_id, hire_date, salary)
VALUES (302,'Grigorz','Polanski', 'IT_PROG', '2017-06-15', 4200);

INSERT INTO copy_employees (ID, first_name, last_name, email, job_id, hire_date, salary)
VALUES (302,'Grigorz','Polanski', 'gpolanski@example.com', 'IT_PROG', '2017-06-15', 4200);

INSERT INTO copy_employees (ID, first_name, last_name, email, hire_date, job_id, salary)
VALUES (304,'Test',CURRENT_USER, 't_user@example.com', NOW(), 'ST_CLERK',2500);
...
INSERT INTO copy_employees (ID, first_name, last_name, email, hire_date, job_id, salary)
VALUES (301,'Katie','Hernandez', 'khernandez@example.com', TO_DATE('July 8, 2017', 'Month DD, YYYY'), 'MK_REP',4200);

INSERT INTO copy_employees (ID, first_name, last_name, email, hire_date, job_id, salary)
VALUES (303,'Angelina','Wright', 'awright@example.com', TO_DATE('July 10, 2017 17:20', 'Month DD, YYYY HH24:MI'), 'MK_REP', 3600);
...
UPDATE copy_employees SET phone_number = '654321', last_name = 'Jones' WHERE ID >= 303;

UPDATE copy_employees SET salary = (SELECT salary FROM copy_employees WHERE ID = 100) WHERE ID = 101;

UPDATE copy_employees
SET salary = (SELECT salary FROM copy_employees WHERE ID = 205),
    job_id = (SELECT job_id FROM copy_employees WHERE ID = 205)
WHERE ID = 206;

UPDATE copy_employees SET salary = (SELECT salary FROM employees WHERE ID = 205) WHERE ID = 202;

ALTER TABLE copy_employees ADD COLUMN department_name VARCHAR(30);

UPDATE copy_employees e
SET department_name = (SELECT d.department_name FROM departments d WHERE e.department_id = d.department_id);

DELETE FROM copy_employees WHERE ID = 303;
